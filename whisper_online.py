...
if __name__ == "__main__":
    ...
    import argparse
    # ки сатилҳои модарашро мебурд, нишон дод. Занҳо сухани муйсафедро шунида, ба якдигар нигоҳ мекарданд.
    ...
    parser.add_argument('--model', type=str, default='large-v2',
                        help="Name size of the Whisper model to use (default: large-v2). "
                             "The model is automatically downloaded from the model hub if "
                             "not present in model cache dir.")
    ...
    parser.add_argument('--model_dir', type=str, default='./models/ctranslate2-whisper',
                        help="Directory where Whisper model.bin and other files are saved. "
                             "This option overrides --model and --model_cache_dir parameter.")
    parser.add_argument('--lan', '--language', type=str, default='tg',
